function CustomTooltip(tooltipId, width) {
  ...
  function updatePosition(event) {
    ...
    var ttleft =
      curX - wscrX + xOffset * 2 + ttw > $(window).width()
        ? curX - ttw - xOffset * 2
        : curX + xOffset;
    ...
    var tttop =
      curY - wscrY + yOffset * 2 + tth > $(window).height()
        ? curY - tth - yOffset * 2
        : curY + yOffset;
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      (this.NYDF = 'Other NYDF Signatory'),
        ...
        (this.VALID_NAMES = [
          'Brazil',
          'Indonesia',
          'New_York_Declaration_on_Forests_Signatories',
          'Non_New_York_Declaration_on_Forests_Signatories'
        ]);
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale
        .ordinal()
        .domain(['America', 'Africa', 'Asia'])
        .range(['rgb(112,178,195)', 'rgb(162,206,219)', 'rgb(235,179,160)']);
    ...
    BubbleChart.prototype.move_towards_center = function(alpha) {
      return (function(_this) {
        return function(d) {
          ...
          d.x =
            d.x + (_this.center.x - d.x + 150) * (_this.damper + 0.02) * alpha;
          return (d.y =
            d.y + (_this.center.y - d.y) * (_this.damper + 0.02) * alpha);
        };
      })(this);
    };
              ...
              _this.circles
                ...
                .attr('r', function(d) {
                  ...
                  if (that.VALID_NAMES.indexOf(d.name) != -1) {
                    document.getElementById(d.name + '_data').innerHTML =
    ...
    BubbleChart.prototype.move_towards_year = function(alpha) {
      return (function(_this) {
        return function(d) {
          ...
          return (d.y =
            d.y + (target.y - d.y) * (_this.damper + 0.02) * alpha * 1.1);
        };
      })(this);
    };
    ...
    BubbleChart.prototype.generateCircles = function(values_array) {
      ...
      circles
        ...
        .each(function(d) {
          ...
          values_array = values_array.filter(function(i) {
          ...
          for (var i = 0; i < values_array.length; i++) {
            ...
            if (this.id == id_search_string) {
              ...
              label_text = that.get_label_text(
                i,
                coordinates,
                this.id,
                d.name,
              ...
              document
                ...
                .insertAdjacentHTML('afterend', label_text);
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      var figure = function(data) {
        ...
        return data.value * 100 > 1
          ? ~~(data.value * 100)
          : (data.value * 100).toFixed(3);
      };
      content +=
