...
define([
  ...
  'map/views/layers/UptakeTotal2038Layer',
  'map/views/layers/UptakeTotal2048Layer',
  ...
  UptakeTotal2038Layer,
  UptakeTotal2048Layer,
  ...
  var layersHelper = {
    ...
    total_2038: {
      view: UptakeTotal2038Layer,
      timelineView: GainTimeline
    },
    total_2048: {
      view: UptakeTotal2048Layer,
      timelineView: GainTimeline
    },
    crops_1: {
