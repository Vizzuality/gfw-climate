  ...
  function(
    ...
    var AnalysisResultsView = Backbone.View.extend({
      ...
      parseData: function(res) {
        ...
        var barValues = _.map(data.co2LossByYear, function(v, k) {
          return { year: k, value: v };
        });
        var lineValues = _.map(data.treeLossByYear, function(v, k) {
          return { year: k, value: v };
        });
        var dataParsed = [];
      ...
      setParams: function(params) {
        this.params = params;
        this.params.warning_text =
          this.$analysisTab.find('li.active').data('analysis') === 'draw-tab';
        this.params.downloadVisible =
          (this.params.loss || this.params.forestgain) && this.mobile
            ? false
            : true;
      ...
      _deleteAnalysis: function() {
        ...
        var title =
          this.params && this.params.layer
            ? this.params.layer.title
            : 'No layer title';
      ...
      _toggleDownloads: function(e) {
        ...
        ga(
          ...
          'Map',
          'Download',
          'Downloads-' + 'Layer: ' + this.params.layer.title
        );
      },
      ...
      setDownloadLink: function(layer) {
        var links = {
          ...
          forestgain:
            'http://data.globalforestwatch.org/datasets/6c9f379a362e4926ad24b58444f4ba67',
          forma:
            'http://data.globalforestwatch.org/datasets/39a527e300ff4146962a3c74ec476f64',
