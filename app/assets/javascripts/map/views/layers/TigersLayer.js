...
define(
  ...
  function(CartoDBLayerClass, TigerCartoCSS) {
    ...
    var TigersLayer = CartoDBLayerClass.extend({
      options: {
        sql:
          "SELECT the_geom_webmercator, cartodb_id, the_geom, tcl_name as name, area_ha, tx2_tcl, 'tiger_conservation_landscapes' AS tablename, 'tiger_conservation_landscapes' as layer, {analysis} AS analysis " +
