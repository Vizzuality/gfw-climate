  ...
  function($, _, Handlebars, tpl) {
    ...
    CustomInfowindow.prototype.draw = function() {
      ...
      if (!div) {
        ...
        div.innerHTML =
          this.options.infowindowContent ||
          this.template({ content: { data: this.options.infowindowData } });
    ...
    CustomInfowindow.prototype.setPosition = function() {
      ...
      if (point) {
        div.style.top =
          point.y + this.options.offset[0] - div.clientHeight + 'px';
        div.style.left =
          point.x + this.options.offset[1] - this.options.width / 2 + 'px';
      }
    };
