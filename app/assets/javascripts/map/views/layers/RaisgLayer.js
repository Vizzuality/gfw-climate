...
define(
  ...
  function(WMSLayerClass, honduras_forestCartoCSS) {
    ...
    var wmsUrl =
      'http://gisserver.socioambiental.org:6080/arcgis/services/raisg/raisg_tis/MapServer/WMSServer?';
    wmsUrl += '&SERVICE=WMS';
    ...
    wmsUrl += '&WIDTH=256';
    wmsUrl +=
      '&SLD=http://gfw-nav.herokuapp.com/assets/map/cartocss/polygon_polygonSymbolizer.xml';
