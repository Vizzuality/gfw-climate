...
define(
  ...
  function(CartoDBLayerClass, BraBiomesCartoCSS) {
    ...
    var BraBiomesLayer = CartoDBLayerClass.extend({
      options: {
        sql:
          "SELECT cartodb_id, the_geom_webmercator, name, (round(shape_area)*1000000) as area_ha, '{tableName}' AS tablename, {analysis} AS analysis, '{tableName}' AS layer FROM {tableName}",
        infowindow: true,
