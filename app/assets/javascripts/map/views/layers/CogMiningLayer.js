...
define(['abstract/layer/CartoDBLayerClass'], function(CartoDBLayerClass) {
  ...
  var CogMiningLayer = CartoDBLayerClass.extend({
    options: {
      sql:
        "SELECT 'cog_mining' as tablename, cartodb_id, the_geom_webmercator, nom_societ as company, sup_off_2 area_ha, nom_permit as name, '{tableName}' AS layer, {analysis} AS analysis FROM {tableName}",
      infowindow: true,
