...
define(
  ...
  function(
    ...
    var FEATURE_PANTROPICAL_DATA =
      window.gfw.config.FEATURE_PANTROPICAL_DATA === 'true';
    ...
    var MapView = Backbone.View.extend({
      ...
      updateLayer: function(layerSlug) {
        ...
        options.uncertainty =
          !isNaN(layer.uncertainty) && layer.uncertainty !== 128
            ? layer.uncertainty
            : null;
        this._removeLayer(layerSlug);
      ...
      _appearMenu() {
        $('body').mousemove(function(event) {
          ...
          if (event.pageY > 120) {
            ...
            var hoverMenuDashboard = $('.m-header-sub-menu-dashboard').is(
              ':hover'
            );
            var dashboardMenuOpen = $('.m-header-sub-menu-dashboard').hasClass(
              '-active'
            );
            var loginMenuOpen = $('.m-header-sub-menu-login').hasClass(
              '-active'
            );
