...
define(
  ...
  function(_, Backbone, amplify, utils, PlaceService) {
    ...
    var Router = Backbone.Router.extend({
      ...
      routes: {
        'map(/:zoom)(/:lat)(/:lng)(/:iso)(/:maptype)(/:baselayers)(/:sublayers)(/)':
          'map',
        'embed/map(/:zoom)(/:lat)(/:lng)(/:iso)(/:maptype)(/:baselayers)(/:sublayers)(/)':
          'embed'
      },
      ...
      _checkForCacheBust: function() {
        ...
        if (
          _.has(params, 'cache') ||
          localCacheVersion !== _.toNumber(this._cacheVersion)
        ) {
      ...
      isLocalStorageNameSupported: function() {
        ...
        if (typeof localStorage === 'object') {
          try {
            ...
            alert(
              'You may not be able to experience full functionality of the map while in private mode because your web browser does not support storing settings locally. In Safari, the most common cause of this is using "Private Browsing Mode".'
            );
          }
        }
      },
