define(['backbone', 'd3'], function(Backbone, d3) {
  ...
  var TotalEmissionsView = Backbone.View.extend({
    ...
    _renderChart: function(params) {
      ...
      tooltip.append('div').attr('class', 'bottom');

      var tooltipContent = d3.select(tooltipEl).select('.content');

      tooltipContent
        .append('div')
        .attr('class', 'title')
        .text(infoWindow);
      tooltipContent.append('div').attr('class', 'value number');
      ...
      focus.append('circle').attr('r', radius);
      ...
      svg
        ...
        .on('mouseover', function() {
          ...
          d3.select(tooltipEl).style('display', 'block');
        })
