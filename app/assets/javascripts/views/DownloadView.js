    ...
    var DownloadView = Backbone.View.extend({
      ...
      text: {
        default: {
          ...
          description:
            'Enter your email to receive a link to browse and download data for this country'
        },
        'country-stats': {
          title: 'Request a download link',
          description:
            'Enter your email to receive a link to download tree cover statistics for this country'
        },
        'forest-change': {
          title: 'Request a download link',
          description:
            'Enter your email to receive a link to download this data for your area of interest'
        }
      },
      ...
      render: function() {
        if (this._isMobile()) {
          this.$el.html(
            this.template({ text: this.text[this.model.get('type')] })
          );
        }
      },
