  ...
  function(
      ...
      continue: function(e) {
        ...
        if (!!this.status.get('compare1') && !!this.status.get('compare2')) {
          ga(
            ...
            'Compare Page',
            'Select Countries',
            this.status.get('compare1').iso +
              ':' +
              this.status.get('compare2').iso
          );
          this.hide();
        }
      },
    ...
    */
      ...
      changeIso: function(e) {
        ...
        !!$(e.currentTarget).val()
          ? this.$contentWrapper.addClass('is-loading')
          : null;
      },

      changeJurisdiction: function(e) {
        var jurisdiction = $(e.currentTarget).hasClass('is-active')
          ? 0
      ...
      changeArea: function(e) {
        var area = $(e.currentTarget).hasClass('is-active')
          ? 0
          : $(e.currentTarget).data('id');
    ...
    */
      setTab: function(tab) {
        ...
        this.$el
          .find('.js-modal-tablink[data-tab=' + tab + ']')
          .addClass('is-active');
      ...
      setCompare: function(who, compare) {
        ...
        if (compare) {
          var $select = $('#selection' + who).find('select'),
            ...
            $jurisdictions = $('#selection' + who).find(
          ...
          if (!!compare.area) {
            $areas
              .find('li[data-id=' + compare.area + ']')
              .addClass('is-active');
          }
          if (!!compare.jurisdiction) {
            $jurisdictions
              .find('li[data-id=' + compare.jurisdiction + ']')
              .addClass('is-active');
          }
        }
      }
