  ...
  function(Backbone, Handlebars, _, d3, moment, NumbersHelper, tplTooltip) {
    ...
    var GladAlertsVis = Backbone.View.extend({
      ...
      _setAxisScale: function() {
        ...
        this.x = d3.time.scale().range([0, this.cWidth]);
      ...
      _getDomain: function() {
        ...
        return {
          ...
          x2: d3.extent(x2Values, function(d) {
            return d;
          }),
          y: d3.extent(yValues, function(d) {
            return d;
          }),
          r: d3.extent(rValues, function(d) {
            return d;
          })
        };
      },
      ...
      _setDomain: function() {
        ...
        this.y.domain([
          this.domain.y[0],
          d3.max(this.y.ticks(numTicks)) + this.y.ticks(numTicks)[2]
        ]);
      },
      ...
      _drawDots: function() {
        ...
        var dotsGroup = this.svg
          ...
          .attr(
            'transform',
            'translate( 0,' + -this.defaults.paddingAxisLabels + ')'
          );
        ...
        dotsGroup
          ...
          .style('transform-origin', function(d) {
            return (
              Math.round(_this.x2(d[_this.dataColumns.dots.x])) +
              'px ' +
              Math.round(_this.y(d[_this.dataColumns.dots.y])) +
              'px'
            );
          });
      },
      ...
      _drawDashedLine: function() {
        ...
        var line = d3.svg
          ...
          .y(function(d) {
            return _this.y(d[_this.dataColumns.dashed.y]);
          })
      ...
      _drawSemiDashedLine: function() {
        ...
        var dashedLine = this.svg
          ...
          .attr(
            'transform',
            'translate( 0,' + -this.defaults.paddingLinesLabels + ')'
          );
        ...
        var line = d3.svg
          ...
          .y(function(d) {
            return _this.y(d[_this.dataColumns.semiDashed.y]);
          })
          .interpolate(this.defaults.interpolate);
      ...
      _drawSolidLine: function() {
        ...
        this.linePath = d3.svg
          .line()
          .x(function(d) {
            return _this.x2(d[_this.dataColumns.line.x]);
          })
          .y(function(d) {
            return _this.y(d[_this.dataColumns.line.y]);
          })
          .interpolate(this.defaults.interpolate);
      ...
      _addLineLabel: function(el, value) {
        ...
        if (this.unit.search(this.defaults.underscript) !== -1) {
          ...
          el.append('tspan').text(this.unit);
        }
      },
      ...
      _updateTooltip: function(step) {
        ...
        if (data) {
          var tooltip = this.el.querySelector('.tooltip');
          var emissions = parseFloat(
            (data.cumulative_emissions * 1).toFixed(2)
          );
          var deforestation = parseFloat(
            (data.cumulative_deforestation * 1).toFixed(2)
          );
      ...
      _drawBrush: function() {
        ...
        this.slider.selectAll('.extent,.resize').remove();
      ...
      _onBrush: function() {
        ...
        if (this.isEmbed) {
          Backbone.Events.trigger(
            ...
            this._getCurrentState(this.currentStep)
          );
        }
      ...
      _setHoverEvent: function() {
        var _this = this;
        d3.select('svg .background').on('mousemove', function() {
      ...
      _drawHandle: function() {
        ...
        this.handleContainer
          ...
          .attr(
            'transform',
            'translate(0, ' +
              (this.cHeight + this.defaults.margin.bottom / 2) +
              ') scale(1.5, 1)'
          );
        ...
        this.handleContainer
          ...
          .attr(
            'transform',
            'translate(0, ' +
              (this.cHeight + this.defaults.margin.bottom / 2 + 2) +
              ') scale(1.5, 0.9)'
          );
      },
      ...
      _setHandlePosition: function() {
        ...
        this.handleContainer.attr('transform', function() {
          return (
            'translate(' +
            (_this.x2(_this.currentStep) - _this.defaults.handleWidth / 2) +
            ', 0)'
          );
        });
      },
