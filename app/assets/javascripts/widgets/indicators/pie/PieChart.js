define(['jquery', 'd3', 'underscore', 'enquire'], function($, d3, _, enquire) {
  ...
  var PieChart = function(options) {
    ...
    color = d3.scale.ordinal().range(arrayColor);
        ...
        .attr(
          ...
          function() {
            if (this.mobile) {
              ...
              return (
                'translate(' +
                (this.parentWidth - this.parentHeight / 2) +
                ', ' +
                this.parentHeight / 2 +
                ')'
              );
