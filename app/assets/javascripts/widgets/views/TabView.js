define(
  ...
  function(
    ...
    averageTpl,
    LineChartIndicator,
    MultiLineChartIndicator,
    MapIndicator,
    PieChartIndicator,
    NumberChartIndicator,
    ListChartIndicator,
    StackedChartIndicator
  ) {
    'use strict';
    ...
    var TabView = Backbone.View.extend({
      ...
      toggleDisabledDates: function() {
        _.each(
          ...
          _.bind(function(el) {
            ...
            var compare = $(this.$el.find($(el).data('compare')))[0]
              .selectedIndex;
      ...
      setIndicator: function() {
        ...
        if (t && t.type) {
          switch (t.type) {
            case 'line':
              indicators = _.where(this.presenter.model.get('indicators'), {
                unit: t.unit
              });
              if (!!indicators.length) {
                this.indicator = new MultiLineChartIndicator({
                  ...
                  model: {
                    ...
                    unit: t.unit,
                    unitname: _.findWhere(
                      this.presenter.model.get('data').switch,
                      { unit: t.unit }
                    ).unitname,
                    ...
                    lock: t.lock,
                    location_compare: this.presenter.model.get(
                      'location_compare'
                    ),
              ...
              if (!!indicators.length) {
                this.indicator = new PieChartIndicator({
                  ...
                  model: {
                    indicators: indicators,
                    section: t.section,
                    sectionswitch: this.presenter.model.get('data')
                      .sectionswitch,
                    template: t.template,
                    type: 'pie'
                  },
            ...
            case 'number':
              ...
              if (!!indicators.length) {
                this.indicator = new NumberChartIndicator({
                  ...
                  model: {
                    id: !!t.unit
                      ? _.findWhere(indicators, { unit: t.unit }).id
                      : indicators[0].id,
                    template: t.template,
                    type: 'number'
                  },
            ...
            case 'stacked':
              ...
              if (!!indicators.length) {
                this.indicator = new StackedChartIndicator({
                  ...
                  model: {
                    unit: t.unit,
                    unitname: _.findWhere(this.model.data.switch, {
                      unit: t.unit
                    }).unitname,
                    indicators: indicators,
                    template: t.template,
