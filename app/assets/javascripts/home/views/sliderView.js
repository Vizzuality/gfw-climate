 ...
 */
define(
  ['jquery', 'backbone', 'underscore', 'mps', 'enquire', 'handlebars', 'slick'],
  function($, Backbone, _, mps, enquire, Handlebars, slick) {
    ...
    var SlideView = Backbone.View.extend({
      ...
      events: {
        ...
        'mouseenter .feature-slider .slick-dots li':
          '_onSliderFeatureHighlight',
        'mouseleave .feature-slider .slick-dots li':
          '_onSliderFeatureUnHighlight'
      },
      ...
      _onHtmlClick: function(e) {
        if (
          !$(e.target).hasClass('submenu-tooltip') &&
          this.$getStarted.hasClass('active')
        ) {
